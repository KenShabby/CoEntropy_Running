...
HR_ZONE_PERCENTAGES: Dict[
    ...
    (SegmentType.RECOVERY_RUN, HeartRateZoneMethods.LTHR): (0.6, 0.76),
    ...
    (SegmentType.LONG_RUN, HeartRateZoneMethods.LTHR): (0.85, 0.9),
    ...
    (SegmentType.MARATHON_PACE_RUN, HeartRateZoneMethods.LTHR): (0.88, 0.95),
    ...
    (SegmentType.EASY_RUN, HeartRateZoneMethods.LTHR): (0.81, 0.89),
    # --- Intervals ---
    ...
    (SegmentType.INTERVALS, HeartRateZoneMethods.LTHR): (0.95, 1.00),
}
